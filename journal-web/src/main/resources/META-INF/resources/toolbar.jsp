...
>
	...
	<liferay-frontend:management-bar-action-buttons>
		...
		<liferay-frontend:management-bar-button href='<%= "javascript:" + renderResponse.getNamespace() + "deleteEntries();" %>' icon='<%= trashHelper.isTrashEnabled(scopeGroupId) ? "trash" : "times" %>' label='<%= _trashHelper.isTrashEnabled(scopeGroupId) ? "recycle-bin" : "delete" %>' />
